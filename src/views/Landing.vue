            ...
            <div class="w-full md:w-6/12 lg:w-3/12 lg:mb-0 mb-12 px-4">
              <div class="px-6">
                ...
                <div class="pt-6 text-center">
                  <h5 class="text-xl font-bold">Giovanni Noceti Bracking</h5>
                  ...
                  <div class="mt-6">
                    ...
                    >
                      <a
                        href="https://www.instagram.com/noceti_viking_way"
                        target="_blank"
                        class="instagram"
                      >
                    ...
                    >
                      <a
                        href="https://www.linkedin.com/in/giovanni-noceti-bracking-121b13191/"
                        target="_blank"
                      >
                    ...
                    >
                      <a
                        href="https://gitlab.com/giovanni.noceti"
                        target="_blank"
                      >
              ...
              >
                <div class="flex-auto p-5 lg:p-10">
                  <form
                    ...
                    role="form"
                  >
                    <h4 class="-2xl font-semibold">Contacto</h4>
                    <p class="leading-relaxed mt-1 mb-4 text-gray-600">
                      Si tienes alguna inquietud o sugerencia, rellena este
                    ...
                    <div class="relative w-full mb-3 mt-8">
                      ...
                      <div v-if="$v.formContact.name.$error">
                        <p
                          class="text-red-500"
                          v-if="!$v.formContact.name.required"
                        >
                    ...
                    <div class="relative w-full mb-3">
                      ...
                      <div v-if="$v.formContact.email.$error">
                        <p
                          class="text-red-500"
                          v-if="!$v.formContact.email.required"
                        >
                          El campo email es requerido!
                        </p>
                        <p
                          class="text-red-500"
                          v-if="!$v.formContact.email.email"
                        >
                          El campo email debe ser valido!
                        </p>
                      </div>
                    </div>
                    <div class="relative w-full mb-3">
                      ...
                      <div v-if="$v.formContact.subject.$error">
                        <p
                          class="text-red-500"
                          v-if="!$v.formContact.subject.required"
                        >
                    ...
                    <div class="relative w-full mb-3">
                      ...
                      <div v-if="$v.formContact.message.$error">
                        <p
                          class="text-red-500"
                          v-if="!$v.formContact.message.required"
                        >
                          El campo mensaje es requerido!
                        </p>
                        <p
                          class="text-red-500"
                          v-if="!$v.formContact.message.minLength"
                        >
                          El campo mensaje debe contener al menos 4 caracteres!
                        </p>
                        <p
                          class="text-red-500"
                          v-if="!$v.formContact.message.maxLength"
                        >
                          El campo mensaje debe contener 500 caracteres o menos!
                        </p>
                      </div>
                    </div>
          ...
          <div class="flex flex-wrap justify-center pt-8">
            <div class="w-full lg:w-6/12 px-4">
              ...
              >
                <div class="flex-auto p-5 lg:p-10">
                  <form
                    action="api/landing/suscribe"
                    @submit.prevent="setSuscriptor()"
                    method="post"
                  >
                    <h4 class="text-2xl font-semibold">¡Suscribete!</h4>
                    <p class="leading-relaxed mt-1 mb-4 text-gray-600">
                      Si no quieres perderte las novedades que tenemos para ti
                      ¡suscribete!.
                    </p>
                    ...
                    <div class="relative w-full mb-3">
                      ...
                      <div v-if="$v.formSuscriber.email.$error">
                        <p
                          class="text-red-500"
                          v-if="!$v.formSuscriber.email.required"
                        >
                          El campo email es requerido!
                        </p>
                        <p
                          class="text-red-500"
                          v-if="!$v.formSuscriber.email.email"
                        >
                          El campo email debe ser valido!
                        </p>
                      </div>
...
export default {
  ...
  methods: {
    sentMessage() {
      ...
      axios
        .post(apiUrl + "/landing/contactUs", this.formContact)
        .then((res) => {
    ...
    setSuscriptor() {
      const apiUrl = process.env.VUE_APP_URL_API;
      axios
        .post(apiUrl + "/landing/suscribe", this.formSuscriber)
        .then((res) => {
          if (res.data._errorMessages) {
            this.$vToastify.error(res.data._errorMessages[0].message);
