        ...
        <ul class="flex flex-col lg:flex-row list-none lg:ml-auto">
          ...
          <li class="flex items-center">
            <router-link to="/auth/login">
              <button
                v-if="!isLoggedIn"
                class="text-white bg-gray-800 active:bg-gray-100 text-xs font-bold uppercase px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none lg:mr-0 lg:mb-0 ml-3 mb-3 ease-linear transition-all duration-150"
                type="button">              
